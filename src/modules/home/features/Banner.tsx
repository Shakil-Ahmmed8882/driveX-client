      ...
      <div className="lg:flex gap-3 items-end">
        <article className="flex-2 w-full h-72 lg:h-auto flex flex-col items-center justify-center lg:w-2/3 absolute lg:static top-32 z-20">
          <div className="pb-8 w-full text-center lg:text-left lg:items-start">
            <h2 className="text-3xl pb-4 sm:text-[30px] md:text-[35px] leading-snug font-bold mb-4 lg:mb-8 lg:text-[48px]">
            ...
            {cars.map((car, index) => (
              ...
              >
                ...
                <div className="absolute bottom-4 left-4 text-white flex justify-between w-[90%]">
                  <h3 className="font-semibold p-1 px-3 bg-[#ededed] rounded-full text-[#000] text-sm">{car.name}</h3>
        ...
        <article className=" flex-2 absolute lg:static top-32">
          <motion.div
            initial="hidden"
            animate="visible"
            variants={imageVariants}
          ...
          >
            <img
              ...
              className="object-cover h-72 lg:h-96 w-[800px] md:w-[1000px] lg:w-[700px] lg:rounded-lg"
            />
           
           <div className="absolute bottom-4 left-4 text-white hidden lg:flex justify-between w-[90%]">
                  <h3 className="font-semibold p-1 px-3 bg-[#ededed] rounded-full text-[#000] text-sm"> Vorolionaion Europ</h3>
                  <div className="flex items-center space-x-2">
                    <span>4</span>
                    <span className="w-4 h-4 bg-white rounded-full text-black flex items-center justify-center"></span>
                  </div>
